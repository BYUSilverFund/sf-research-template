...
results_dir = Path("results/conditional_bma_reversal/experiment_14")
...
save_table_image(
    ...
    title="Top 20 Overbought Scores (Overall)", 
...
save_table_image(
    ...
    title="Realized 21-Day Returns for Top 20 Shorts", 
...
save_table_image(
    ...
    title="Realized 21-Day Returns for Top 10 Biotech Shorts", 
