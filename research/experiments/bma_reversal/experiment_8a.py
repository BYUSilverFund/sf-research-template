...
signal_name_title = "Fast Decayed Log-Volume BMA"
IC = 0.05
gamma = 90
n_cpus = 8
constraints = [
...
checkpoint_dir = Path("temp/checkpoints_fast_decay")
...
# Calculate the raw, unfiltered alpha
alphas_raw = (
    signals
    .filter(
...
# Apply Exponential Decay (EWMA) to smooth the final signal
alphas = (
    alphas_raw
    .sort("date")
    .with_columns(
