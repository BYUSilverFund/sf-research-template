...
price_filter = 5
signal_name = "decayed_volume_bma"
signal_name_title = "Decayed Log-Volume BMA"
IC = 0.05
gamma = 140  
n_cpus = 8
constraints = [
...
checkpoint_dir = Path("temp/checkpoints_decay")
...
# Step 1: Calculate the raw, unfiltered alpha
alphas_raw = (
    signals
    .filter(
...
# Step 2: Apply Exponential Decay (EWMA) to smooth the final signal
alphas = (
    alphas_raw
    .sort("date")
    .with_columns(
